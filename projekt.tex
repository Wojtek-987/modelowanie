...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{./img/dane empiryczne-wwl-dtr.png}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{./img/dane empiryczne-wwl-vgo.png}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{./img/dane empiryczne-vgo-dtr.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{./img/gestosc-laczna-wwl-dtr.png}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{./img/gestosc-laczna-wwl-vgo.png}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{./img/gestosc-laczna-vgo-dtr.png}
\end{figure}
