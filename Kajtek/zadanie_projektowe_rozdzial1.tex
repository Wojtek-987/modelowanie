...
\section {Analiza log-zwrotów spółki (Vigo Photonics)}
...
\centerline{\includegraphics[width=1\textwidth]{./img/kursy_zamkniecia_plot.png}}
...
\centerline{\includegraphics[width=1\textwidth]{./img/log_zwroty_plot.png}}
...
\subsection{Histogram log-zwrotów}
...
\centerline{\includegraphics[width=1\textwidth]{./img/histogram_zwrotow.png}}
...
\centerline{\includegraphics[width=1\textwidth]{./img/dystrybuanta.png}}

\subsection{Analiza dobroci dopasowania rozkładu normalnego i t-Studenta}
...
\centerline{\includegraphics[width=1\textwidth]{./img/diagnostical-plots.png}}
