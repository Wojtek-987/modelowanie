...
\pagebreak
\subsection{Digitree - Jan Milewczyk}
...
\pagebreak
\subsection{Wawel - Maciej Wojciechowski}
...
\newpage\subsection{Wzór gęstości rozkładu normalnego}
...
\begin{multline}
    ...
    \exp(-\frac{1}{1.999372} 
    [\frac{(x_1-0.0014818927)^2}{3.157575e-04}\\ -0.05011604\frac{(x_1-0.0014818927)(x_2-0.0005527318)}{0.0008438382}+\frac{(x_2-0.0005527318)^2}{2.255094e-03})
\end{multline}

\begin{multline}
    f(w,v)=\frac{1}{0.003546984}\exp(-\frac{1}{1.984239}[\frac{(x_1-0.001481893)^2}{3.157575e-04}\\ -0.177545\frac{(x_1-0.001481893)(x_2-(-0.001203487))}{0.0005667577}+\frac{(x_2-(-0.001203487))^2}{0.0010172816}])
\end{multline}

\begin{multline}
    f(v,d)=\frac{1}{0.009465047}\exp(-\frac{1}{1.978381}[\frac{(x_1-(-0.0012034874))^2}{0.0010172816}\\-0.2079392\frac{(x_1-(-0.0012034874))(x_2-0.0005527318)}{0.001514617}+\frac{(x_2-0.0005527318)^2}{0.0022550944}])
\end{multline}
...
\newpage\subsection{Wzory gęstości rozkładów brzegowych}
Korzystając z faktu, ze rozklady brzegowe wektora normalnego dwuwymiarowego
$$(X_1, X_2)\backsim N(\mu_1, \mu_2, \sigma_1, \sigma_2, \rho)$$ 
sa rozkladami normalnymi jednowymiarowymi
$$X_1\backsim N(\mu_1, \sigma_1^2), X_2\backsim N(\mu_2, \sigma_2^2)$$
wykorzystamy gestosci nastepujacych rozkladow:
$$WWL\backsim N(0.0014818927, 3.157575e-04)$$
$$VGO\backsim N(-0.0012034874, 0.0010172816)$$
$$DTR\backsim N(0.0005527318, 0.0022550944)$$
